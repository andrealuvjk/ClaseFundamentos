...
##si la cadena de texto es numerica
siTieneNumero = "Andrea 2006"
##este texto tiene un numero -> true
##isnueric
respuesta = siTieneNumero.isnumeric()
print(respuesta)

isLowerCase = "Ella se fue, me abandono y destrozo mi corazon"
minuscula = isLowerCase.islower()
print("solo minusculas", minuscula)

## solo debe de tener mayusculas
fraseIconica = "Soltala Erika"
respuesta = fraseIconica.isupper()
##esta funcion se encadenar con otra
print(respuesta)
